...
//   })
       ...
       await signinwithgoogle()
            .then(result => {
                ...
                const newuserinfo = { email:result?.user?.email,task_completion:0, image:result?.user?.photoURL, fullName:result?.user?.displayName,role:'worker', userCoin:10 };
...
<div className="card shrink-0 w-full max-w-sm shadow-2xl border-l-2 border-blue-900 bg-base-100">
  ...
  <div className="flex justify-center space-x-4">
		<button aria-label="Log in with Google" className="p-3 rounded-sm" onClick={() => handlingGoogleSignIn()}>
